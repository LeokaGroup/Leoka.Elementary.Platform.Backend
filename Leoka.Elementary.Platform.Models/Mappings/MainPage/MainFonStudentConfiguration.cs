...
public partial class MainFonStudentConfiguration : IEntityTypeConfiguration<MainFonStudentEntity>
{
    ...
    partial void OnConfigurePartial(EntityTypeBuilder<MainFonStudentEntity> entity);
}